...
export class ChatService {
    ...
    private aiAgent: ChatAgent;
    private reportService: ReportService;

    constructor(repo: ChatRepository, reportService: ReportService) {
        this.repo = repo;
        this.aiAgent = new ChatAgent(); // Or inject this too
    ...
    public async handleUserMessage(
        ...
        const aiMsg = await this.aiAgent.processUserMessage(session, userText);
