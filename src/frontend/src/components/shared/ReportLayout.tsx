...
import { RewritableText } from "../RewritableText";
import { DiffView } from "../DiffView";
import { HighlightableText } from "../HighlightableText";
import { AIChatInput } from "./AIChatInput";
import { PeerReviewPanel } from "../PeerReviewPanel";
import { ImageWithFallback } from "../figma/ImageWithFallback";
import { PeerReview } from "../../App";
import {
  ArrowLeft,
  Download,
  Sparkles,
...
interface ReportLayoutProps {
  ...
  onAddReviewComment?: (comment: string, type: "issue" | "suggestion" | "question") => void;
  onAddHighlightComment?: (highlightedText: string, sectionId: number, comment: string, type: "issue" | "suggestion" | "question") => void;
...
export function ReportLayout({
  ...
  useEffect(() => {
    const handleMouseMove = (e: MouseEvent) => {
      ...
      const maxWidth = window.innerWidth * 0.5; // Maximum 50% of screen width
    ...
    <div className="flex h-[calc(100vh-73px)] overflow-hidden">
      ...
      <div 
        ...
        style={{
          ...
          maxWidth: isChatCollapsed ? '48px' : `${window.innerWidth * 0.5}px`,
