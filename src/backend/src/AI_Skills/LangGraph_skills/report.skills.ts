...
//   },
    ...
    },
    {
      ...
      schema: z.object({
        ...
        content: z.string().describe(`The markdown content for this section
          CRITICAL FORMATTING: 
          - If this is an Observations section, you MUST use a Markdown Table (Columns: Description | Photo) format for observations that explicitly have an associated image. If you are summarizing general specifications, rules, or observations that do NOT have a photo, write them as standard paragraphs or bullet points outside of the table.
  ...
  //     description: 'Get project details, specifications, and context. Use this to get facts while writing the report.',
  //     schema: z.object({
  //       reasoning: z.string().optional().describe('A "scratchpad" to think out loud and let the user know what you are thinking.'),
  //     }),
  //   }
